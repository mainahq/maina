...
> = {
	...
	"verify/coverage.ts": { "process.cwd": 1 },
	"verify/detect.ts": { "process.cwd": 1 },
	"verify/ignore.ts": { "process.cwd": 1 },
	"verify/mutation.ts": { "process.cwd": 1 },
	"verify/pipeline.ts": { "process.cwd": 1 },
	"verify/proof.ts": { "process.cwd": 1 },
	"verify/secretlint.ts": { "process.cwd": 1 },
	"verify/semgrep.ts": { "process.cwd": 1 },
	"verify/slop.ts": { "process.cwd": 1 },
	"verify/sonar.ts": { "process.cwd": 1 },
	"verify/syntax-guard.ts": { "process.cwd": 1 },
	"verify/trivy.ts": { "process.cwd": 1 },
	"verify/typecheck.ts": { "process.env": 1 },
};
