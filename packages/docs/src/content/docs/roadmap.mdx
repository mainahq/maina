...
## Shipped (v0.5.0) -- Workkit Bootstrap + Team Sync ([#42](https://github.com/mainahq/maina/issues/42))
...
## Shipped (v0.6.0) -- Hosted Verification + PR Checks + Autonomous Workflow ([#43](https://github.com/mainahq/maina/issues/43))
...
## v0.7.0 -- Dashboard + Billing + Self-Improvement Loop ([#44](https://github.com/mainahq/maina/issues/44))
...
## v0.8.0 -- CF Workers Skill + Cross-Dogfooding ([#45](https://github.com/mainahq/maina/issues/45))
...
## v1.0.0 -- Org Migration + Launch ([#46](https://github.com/mainahq/maina/issues/46))

Maina Cloud launches under the @mainahq organization.

- **mainahq.com** -- Project domain, docs at docs.mainahq.com
- **GitHub org** -- github.com/mainahq, transfer from mainahq/maina
