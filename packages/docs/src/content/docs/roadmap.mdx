...
- **14 MCP tools** for IDE integration
- **8 cross-platform skills** for Claude Code, Cline, Codex, Continue, Copilot, Cursor, Gemini CLI, OpenHands, Roo Code, Windsurf, Zed AI (any MCP-compatible client)
...
- **11-host MCP support** -- Claude Code, Cline, Codex, Continue, Copilot, Cursor, Gemini CLI, OpenHands, Roo Code, Windsurf, Zed AI (any MCP-compatible client works)
