...
Maina ships a skills package alongside the CLI. Skills are markdown files that teach AI agents your team's verification workflow -- without requiring the CLI to be installed.
...
**For Cursor / Codex / Gemini CLI:** Point the agent at the skill files or include them in your project's agent instructions.
...
| Cross-platform | Terminal only | MCP-compatible IDEs | Any AI agent |
