...
- **CI environments** where installing 18+ tools is impractical
...
| Tier | Price | Includes |
|------|-------|---------|
| **Free** | $0 | CLI, local verification, MCP server, all 18+ tools |
...
<CardGrid>
  <LinkCard title="Getting Started" description="Install and run your first verification" href="/getting-started" />
  <LinkCard title="CI Integration" description="GitHub Actions setup for cloud verification" href="/ci" />
  <LinkCard title="Verify Engine" description="How the 18-tool pipeline works" href="/engines/verify" />
  <LinkCard title="Commands" description="All 28+ commands including cloud commands" href="/commands" />
</CardGrid>
