...
Maina and CodeRabbit complement each other — Maina handles rule-based verification (linting, security, slop detection) while CodeRabbit handles AI-powered code review.
...
3. **How they work together**
   ...
   On every PR:
   - **Maina** runs 25+ rule-based tools (Biome, Semgrep, Trivy, slop detection, etc.) and posts inline findings
...
<Aside type="tip">
Maina runs rule-based checks first and reports only findings on changed lines. CodeRabbit is AI-powered (nuanced review). Together they cover both the "is it correct?" and "is it good?" dimensions.
</Aside>
