 ...
 *
 * Reads the bootstrap hook's `.maina/dogfood/log.jsonl`, keeps one ISO week
...
import type { LogRecord, Verdict } from "../../.maina/dogfood/hook-bootstrap";
...
export function renderReport(m: WeeklyMetrics): string {
	...
	return [
		...
		"",
		"Generated by `bun run dogfood:report` from the bootstrap PreToolUse hook log (`.maina/dogfood/log.jsonl`).",
		"",
		"## Decisions",
		"",
		"| verdict | count |",
