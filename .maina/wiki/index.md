...
- [Error ID surface for CLI and MCP](wiki/decisions/0033-error-id-surface-for-cli-and-mcp.md) [fresh]
...
- [Symbol page templates for wiki](wiki/decisions/0041-symbol-page-templates-for-wiki.md) [fresh]
...
- [Wiki is a view of the Context engine](wiki/decisions/0034-wiki-is-a-view.md) [fresh]
...
- [Cloud error reporting with account linking](wiki/decisions/0040-cloud-error-reporting-with-account-linking.md) [fresh]
- [Opt-in usage telemetry](wiki/decisions/0038-opt-in-usage-telemetry.md) [fresh]
...
- [DeepWiki-compatible MCP server](wiki/decisions/0037-deep-wiki-compatible-mcp-server.md) [fresh]
- [Fix host delegation for CLI AI tasks](wiki/decisions/0003-fix-host-delegation-for-cli-ai-tasks.md) [fresh]
- [PII and code-content scrubbing library](wiki/decisions/0035-pii-and-code-content-scrubbing-library.md) [fresh]
- [Lint-config and manifest parsers for constitution](wiki/decisions/0036-lint-config-and-manifest-parsers-for-constitution.md) [fresh]
...
- [Pattern sampler for constitution rules](wiki/decisions/0039-tree-sitter-pattern-sampler-for-constitution.md) [fresh]
