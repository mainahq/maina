...
> Auto-generated module article for `cluster-63`.

## Entities

- **detectSlop** (function) — `packages/core/src/verify/slop.ts:434` [PR: 0.0021]
...
- **SlopRule** (type) — `packages/core/src/verify/slop.ts:21` [PR: 0.0006]
